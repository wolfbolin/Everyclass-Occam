...
def main(config, semester, version):
    ...
    # 更新教室课表
    Common.fetch_class_table(config, version, "学生课表", "student_table", "xskb", semester, active_list)
    Common.merge_table_info(config, version, "学生课表", "student_table", "student", semester)
